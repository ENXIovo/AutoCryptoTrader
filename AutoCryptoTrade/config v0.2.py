    ...
    "support": [
      {
        ...
        "importance": "high",
        "reasoning": "Multiple tests within ATR range"
      }
    ],
    "resistance": [
      {
        ...
        "timeframe": "mid-term",
        "importance": "medium",
        "reasoning": "Near Bollinger Band upper boundary"
      }
    ]
  },
  "recommendations": {
    "orders": [
      {
        ...
        "volume": "100",
        "action": "hold",
        "reasoning": "Short-term bullish outlook",
        "stop_loss": "33.50 (1x ATR)",
        "take_profit": "35.50 (2x ATR)"
      }
    ],
    "new_orders": [
      {
        ...
        "volume": "80",
        "action": "create",
        "reasoning": "Take profit near resistance",
        "condition": "Price breaking above 35.50",
        "risk_assessment": "medium",
        "expected_volatility": "ATR ~ 0.80"
      }
    ]
  },
  "analysis_summary": "Market is range-bound with short-term upward pressure..."
}
```
